...
struct ObservedLinkEvidence
{
    ...
    double laggedPredictiveScore = 0.0;
    double directedResponseScore = 0.0;
    double excitationScore = 0.0;
    double directionalityScore = 0.0;
    std::string dominantDirection = "undetermined";
    bool isMissing = false;
    std::string missingReason;
    double noiseLevel = 0.0;
    std::string sceneType;
...
struct InferredTopologyEdge
{
    ...
    double directionalityScore = 0.0;
    std::string dominantDirection = "undetermined";
    double temporalContinuityScore = 0.0;
    double posteriorEdgeProbability = 0.0;
    std::string edgeDynamicState = "emerging";
    uint32_t stabilityAge = 0;
    uint32_t weakeningAge = 0;
    std::string edgeStage = "final";
    std::string falseLinkSuppressionReason;
    int32_t suppressionMediatorObservedNodeId = -1;
...
struct ObservationRuntimeState
{
    ...
    std::map<std::pair<uint32_t, uint32_t>, InferredTopologyEdge> previousInferredEdgeByPair;
...
struct NonCooperativeAttackRecommendation
{
    ...
    double evidenceSupportScore = 0.0;
    double causalSupportScore = 0.0;
    double directionalInfluenceScore = 0.0;
    double temporalStabilityScore = 0.0;
    double localBridgeScore = 0.0;
    double postRemovalDamageScore = 0.0;
    double twoHopReachabilityScore = 0.0;
    double interClusterBridgeScore = 0.0;
    double localCutRiskScore = 0.0;
    double neighborRedundancyPenalty = 0.0;
...
struct NonCooperativeAttackPlan
{
    ...
    double recommendedScore = 0.0;
    std::string recommendationReason;
    std::string inferenceMethod = "multi_metric_graph_fusion_v2";
    double structureScore = 0.0;
    double evidenceSupportScore = 0.0;
    double causalSupportScore = 0.0;
    double directionalInfluenceScore = 0.0;
